#!/usr/bin/env python3
"""
Recuperation des codes promo Maxizoo depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/maxizoo.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/maxizoo.fr"
STORE_NAME = "Maxizoo"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Maxizoo depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-maxizoo)"
    }
    try:
